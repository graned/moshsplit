...
#[openapi(
    paths(
        ...
        super::handlers::payment_handlers::propose_transaction,
        super::handlers::payment_handlers::confirm_transaction,
        super::handlers::payment_handlers::incoming_payments,
        super::handlers::payment_handlers::outgoing_payments,
        super::handlers::payment_handlers::balance_summary,
        super::handlers::payment_handlers::payment_breakdown,
        super::handlers::payment_handlers::list_transactions,
        // balances
    ...
    components(schemas(
        ...
        super::dtos::payment_dtos::ProposeTransactionRequest,
        super::dtos::payment_dtos::ConfirmTransactionRequest,
        super::dtos::payment_dtos::PaymentResponse,
        super::dtos::payment_dtos::PaymentListItem,
        super::dtos::payment_dtos::PaymentTransactionResponse,
        super::dtos::payment_dtos::PaymentTransactionListItem,
        super::dtos::payment_dtos::BalanceSummary,
        super::dtos::payment_dtos::PaymentBreakdown,
        // balance
    ...
    tags(
        ...
        (name = "Payments", description = "Unified payment model — debts and transactions"),
        (name = "Balances", description = "Balance computation and debt simplification"),
        (name = "Stats", description = "Event statistics and payment progress"),
